                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="nama" class="form-control" name="nama" placeholder="Nama Kampus" value="">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="alamat">Alamat<span class="small text-danger">*</span></label>
                                        <textarea id="alamat" class="form-control" name="alamat" placeholder="Alamat Kampus"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="kode_pos">Kode Pos<span class="small text-danger">*</span></label>
                                        <input type="text" id="kode_pos" class="form-control" name="kode_pos" placeholder="Kode Pos" value="">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="telepon">Telepon<span class="small text-danger">*</span></label>
                                        <input type="number" id="telepon" class="form-control" name="telepon" placeholder="Telepon" value="">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group focused">
                                ...
                                <div class="col-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="email" id="karir" class="form-control" name="karir" placeholder="Email Karir" value="">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="logo">Logo<span class="small text-danger">*</span></label>
                                        <input type="file" id="logo" class="form-control" name="logo" placeholder="Logo" value="">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="video">Video<span class="small text-danger">*</span></label>
                                        <input type="file" id="video" class="form-control" name="video" placeholder="Video" value="">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="peta">Link Embeded Google Maps<span class="small text-danger">*</span></label>
                                        <textarea id="peta" class="form-control" name="peta" placeholder="Link Embeded Google Maps"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group focused">
                                        <label class="form-control-label" for="kenapa_vokasi">Kenapa Memilih Vokasi?<span class="small text-danger">*</span></label>
                                        <textarea id="kenapa_vokasi" class="form-control" name="kenapa_vokasi" placeholder="Kenapa Memilih Vokasi"></textarea>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group focused">
                                ...
                                <div class="col-12">
                                    <div class="form-group focused">
                                        ...
                                        <input type="text" id="youtube" class="form-control" name="youtube" placeholder="Youtube" value="">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-group focused">
