...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item {{ Nav::isRoute('profil') }}">
            <a class="nav-link" href="{{ route('profil') }}">
                <i class="fas fa-fw fa-university"></i>
                <span>Profil Kampus</span></a>
        </li>
        <li class="nav-item {{ Nav::isRoute('tentang') }}">
        ...
        <li class="nav-item {{ Nav::isRoute('prodi') }}">
            <a class="nav-link" href="{{ route('prodi') }}">
                <i class="fas fa-fw fa-book"></i>
                <span>Program Studi</span></a>
        </li>
        <li class="nav-item {{ Nav::isRoute('senester') }}">
            <a class="nav-link" href="{{ route('semester') }}">
                <i class="fas fa-fw fa-file"></i>
                <span>Semester</span></a>
        </li>
        <li class="nav-item {{ Nav::isRoute('dosen') }}">
            <a class="nav-link" href="{{ route('dosen') }}">
                <i class="fas fa-fw fa-user-tie"></i>
                <span>Dosen</span></a>
        </li>
        <li class="nav-item {{ Nav::isRoute('prestasi') }}">
